// FILE: sequence.h
// TEMPLATE CLASS PROVIDED: sequence<ItemType>
//
// TEMPLATE PARAMETER, TYPEDEFS, and MEMBER CONSTANTS for the
// sequence<ItemType> class:
//    The template parameter, ItemType, is the data type of the items
//    in the sequence, also defined as sequence::value_type.
...
//     sequence can hold.
//
// CONSTRUCTOR for the sequence<ItemType> template class:
//   sequence()
//     Pre:  (none)
//     Post: The sequence has been initialized as an empty sequence.
//
// MODIFICATION MEMBER FUNCTIONS for the sequence<ItemType> template class:
//   void start()
//     Pre:  (none)
...
//
// CONSTANT MEMBER FUNCTIONS for the sequence<ItemType> template class:
