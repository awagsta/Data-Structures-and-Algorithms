...
#include "sequence.h"  // provides the sequence template class
namespace seq = CS3358_SP16_A04_sequence;
using namespace std;
...
void show_list(seq::sequence<ItemType> src);
// Pre: (none)
// Post: The items of sequence src are printed to cout (one per line).
